...
Pod::Spec.new do |s|
  ...
  s.name         = "CTAPI_DemoSuite"
  s.version      = "2"
  s.summary      = "CTAPI_DemoSuite."
  ...
  s.description  = <<-DESC
                    this is CTAPI_DemoSuite
                   DESC

  s.homepage     = "https://github.com/CTAPIs/CTAPI_DemoSuite"
  ...
  s.source       = { :git => "https://github.com/CTAPIs/CTAPI_DemoSuite.git", :tag => s.version.to_s }
  ...
  s.source_files  = "CTAPI_DemoSuite/CTAPI_DemoSuite/**/*.{h,m}"
